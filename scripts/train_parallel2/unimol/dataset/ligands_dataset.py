...
class MoleculeDataset2:
    ...
    def __getitem__(self, idx: int):
        ...
        atoms = sample["atoms"]
        coordinates = sample["coordinates"]
        masked_atoms, masked_coords, masked_distance, edge_types, target_atoms, coordinates, distance = self._sample_preprocess(smi, atoms, coordinates)
        return masked_atoms, masked_coords, masked_distance, edge_types, \
               target_atoms, coordinates, distance        
